...
Carre.Tile = {
  ...
  load : function(map) {
    ...
    Util.xhr(map, "GET", null, function(result) {
      ...
      _this.generateTileInfo(_this.map.properties.colorNumber, _this.map.properties.tilesetsColorNumber);
    ...
    for (var i in layers) {
      ...
      if (layer.name == "solid") {
        ...
        for (var o in layer.objects) {
          ...
          ender.x = obj.x;
          ender.y = obj.y;
          ender.boundingBox.width = obj.width;
          ender.boundingBox.height = obj.height;
        }
      }
        ...
        for (var o in layer.objects) {
          ...
          bumper.x = obj.x;
          bumper.y = obj.y;
          bumper.boundingBox.width = obj.width;
          bumper.boundingBox.height = obj.height;
        }
      }
   ...
   * @return void
   */
  generateTileInfo : function(colorNumber, tilesetsColorNumber) {
